...
import 'package:actcms_spa_flutter/screens/notification/components/notification_widget.dart';
                ...
                children: [
                  ...
                  if (readNotificationList.isNotEmpty)
                    Column(
                      ...
                      children: [
                        Text(language.lnlNotification, style: boldTextStyle()).paddingAll(8),
