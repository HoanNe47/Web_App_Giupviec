...
import 'package:actcms_spa_flutter/screens/booking/booking_history_component.dart';
import 'package:actcms_spa_flutter/screens/booking/component/booking_detail_handyman_widget.dart';
import 'package:actcms_spa_flutter/screens/booking/component/booking_detail_provider_widget.dart';
import 'package:actcms_spa_flutter/screens/booking/component/countdown_component.dart';
import 'package:actcms_spa_flutter/screens/booking/component/price_common_widget.dart';
import 'package:actcms_spa_flutter/screens/booking/component/reason_dialog.dart';
import 'package:actcms_spa_flutter/screens/booking/component/service_proof_list_widget.dart';
import 'package:actcms_spa_flutter/screens/booking/handyman_info_screen.dart';
import 'package:actcms_spa_flutter/screens/booking/provider_info_screen.dart';
import 'package:actcms_spa_flutter/screens/payment/payment_screen.dart';
...
class _BookingDetailScreenState extends State<BookingDetailScreen> {
  ...
  Widget _action({required BookingDetailResponse bookingResponse}) {
    ...
    } else if (bookingResponse.bookingDetail!.status == BookingStatusKeys.complete && bookingResponse.bookingDetail!.isFreeService == false && (bookingResponse.bookingDetail!.paymentStatus == null)) {
      return AppButton(
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          /// Price Details
                          if (!snap.data!.service!.isFreeService)
                            PriceCommonWidget(
                          ...
                          /// Payment Detail Card
                          if (!snap.data!.service!.isFreeService) paymentDetailCard(snap.data!.bookingDetail!),
