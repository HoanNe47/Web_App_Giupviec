...
class _ChatItemWidgetState extends State<ChatItemWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onLongPress: () async {
        bool? res = await showConfirmDialog(context, 'Are you sure you want to delete the message', positiveText: languages!.lblYes, negativeText: languages!.lblNo, buttonColor: primaryColor);
        if (res ?? false) {
