...
import 'package:spa_manager_flutter/provider/payment/payment_screen.dart';
                                ...
                                Container(
                                  ...
                                  child: Text(
                                    data.identifier == FREE
                                        ...
                                        : "${data.amount.validate().toStringAsFixed(DECIMAL_POINT).formatNumberWithComma()}${appStore.currencySymbol}/${data.type.validate()}",
