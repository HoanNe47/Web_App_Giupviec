...
import 'package:spa_manager_flutter/utils/extensions/color_extension.dart';
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      if (widget.bookingData.isHourlyService) Text('hourly', style: secondaryTextStyle()).paddingSymmetric(horizontal: 4), //TODO
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    8.width,
                    Text(
                      "${formatDate(widget.bookingData.date.validate(), format: DATE_FORMAT_2)} At ${formatDate(widget.bookingData.date.validate(), format: DATE_FORMAT_8)}",
                      style: boldTextStyle(size: 14),
                      maxLines: 2,
                      textAlign: TextAlign.right,
                    ).expand(),
                ...
                if (isUserTypeProvider && widget.bookingData.handyman!.isEmpty && widget.bookingData.status == BookingStatusKeys.accept)
                  Column(
                    children: [
                      ...
                      AppButton(
                        width: context.width(),
                        child: Text(context.translate.lblAssign, style: boldTextStyle(color: white)),
                        color: primaryColor,
                        elevation: 0,
                        onTap: () {
