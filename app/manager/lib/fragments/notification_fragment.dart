...
import 'package:spa_manager_flutter/components/notification_widget.dart';
        ...
        body: RefreshIndicator(
          ...
          child: Stack(
            ...
            children: [
              ...
              Observer(
                builder: (_) => BackgroundComponent().center().visible(!appStore.isLoading && readNotificationList.isEmpty && unReadNotificationList.isEmpty && isApiCalled),
              ),
            ],
          ),
        ),
