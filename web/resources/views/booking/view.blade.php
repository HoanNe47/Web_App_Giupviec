                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        ?>
                                        <div class="col-md-2 galary file-gallary-{{$bookingdata->id}}" data-gallery=".file-gallary-{{$bookingdata->id}}">
                                            @if($extention)
                                        ...
                                        <div class="d-flex flex-column booking-service col-md-6">
                                        ...
                                        <div class="col-md-2">
                                            <b>{{ ($bookingdata->service->type === 'hourly') ? __('messages.duration') : __('messages.quantity') }}</b>
                                            <p>
