            ...
            <div class="modal fade" id="handymanModal" tabindex="-1" aria-labelledby="handymanModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    {{ Form::open(['method' => 'POST','route' => 'handymantogglesetting']) }}
                        ...
                        {{Form::checkbox('Schedule Card', "schedule_card", true)}}{{__('messages.dashboard_card_title',['name' => __('messages.top')] )}}<br>       
                        @else
                        {{Form::checkbox('Schedule Card', "schedule_card", false)}}{{__('messages.dashboard_card_title',['name' => __('messages.top')] )}}<br>      
                        @endif
                    </div>
