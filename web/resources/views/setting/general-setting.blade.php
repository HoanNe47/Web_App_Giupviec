                ...
                <div class="row">
                    ...
                    <div class="col-sm-8 mt-sm-0 mt-2">
                        <div class="custom-file col-md-12">
                            {{ Form::file('site_logo', ['class'=>"custom-file-input custom-file-input-sm detail" , 'id'=>"site_logo" , 'lang'=>"vi" , 'accept'=>"image/*"]) }}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-12">
                <div class="row">
                    ...
                    <div class="col-sm-8 mt-sm-0 mt-2">
                        <div class="custom-file col-md-12">
                            {{ Form::file('site_favicon', ['class'=>"custom-file-input custom-file-input-sm detail" , 'id'=>"site_favicon" , 'lang'=>"vi" , 'accept'=>"image/*"]) }}
