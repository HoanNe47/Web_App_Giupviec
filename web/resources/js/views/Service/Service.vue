                ...
                <div class="col-lg-3 category-sidebar">
                    <div class="sidebar-title d-flex align-items-center justify-content-between">
                        ...
                        <div @click="resetFilter">
                            ...
                            <path d="M18.1085 8.94037C18.1085 8.94037 14.9368 4.5 10.1792 4.5C8.07626 4.5 6.05943 5.3354 4.57242 6.82242C3.0854 8.30943 2.25 10.3263 2.25 12.4292C2.25 14.5322 3.0854 16.549 4.57242 18.036C6.05943 19.5231 8.07626 20.3585 10.1792 20.3585C12.9354 20.3585 15.363 18.851 16.7839 16.9429" stroke="#cc0099" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M19.801 5.65222L19.1194 10.1704L14.6035 9.46938" stroke="#cc0099" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg> 
                        </div>                           
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <multi-select
                                    ...
                                    select-label=""
                                    @input="handleFilterChange"
                                    :placeholder="__('messages.select_provider')"
                        ...
                        <div class="card-body">                        
                            ...
                            <div class="price-rabge-box">
                                ...
                                <div class="d-flex justify-content-between">
                                    <small id="lower-value">{{minVal}}{{currencySymobl}}</small>
                                    <small id="upper-value">{{maxVal}}{{currencySymobl}}</small>
                                </div>
                            </div>
