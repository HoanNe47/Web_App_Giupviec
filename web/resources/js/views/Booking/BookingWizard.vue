       ...
       <b-modal ref="confirmModal" id="confirm" hide-header >
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    <path d="M13.9225 21.6744L21.6766 29.4263L41.2115 9.89136" stroke="#cc0099" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M29.8106 4.85714C27.9717 4.29972 26.0209 4 24 4C12.9543 4 4 12.9543 4 24C4 35.0457 12.9543 44 24 44C35.0457 44 44 35.0457 44 24C44 21.9621 43.6952 19.9953 43.1287 18.1429" stroke="#cc0099" stroke-width="2.5" stroke-linecap="round"/>
                    </svg>
                </div>
