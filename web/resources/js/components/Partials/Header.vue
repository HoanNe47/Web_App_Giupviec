<template>
    <nav class="nav navbar theme navbar-expand-xl bg-white iq-navbar navbar-scroll" aria-label="Main navigation">
                    ...
                    <div class="header-address">
                          <span class="icon">
                            <svg width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path fill-rule="evenodd" clip-rule="evenodd" d="M11.5 8.50051C11.5 7.11924 10.3808 6 9.00051 6C7.61924 6 6.5 7.11924 6.5 8.50051C6.5 9.88076 7.61924 11 9.00051 11C10.3808 11 11.5 9.88076 11.5 8.50051Z" stroke="#cc0099" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                              <path fill-rule="evenodd" clip-rule="evenodd" d="M8.99951 19C7.80104 19 1.5 13.8984 1.5 8.56329C1.5 4.38664 4.8571 1 8.99951 1C13.1419 1 16.5 4.38664 16.5 8.56329C16.5 13.8984 10.198 19 8.99951 19Z" stroke="#cc0099" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                          </span>
                        ...
                        <div class="search-content">
                            <form>
                                <div class="input-group  mb-0">
                                    <input type="text" :placeholder="__('messages.search')" class="form-control" @keyup="getServiceList" v-model="keyword" data-bs-toggle="dropdown" aria-expanded="false">
                                    <svg width="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="search-icon">
                                        <circle cx="11.7669" cy="11.7666" r="8.98856" stroke="currentcolor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></circle>
                                        <path d="M18.0186 18.4851L21.5426 22" stroke="currentcolor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                    </svg>
        ...
        <b-modal id="nearlocation"  title="Nhận dịch vụ gần nhất" header-close-content=" <button type='button' class='btn-close btn-sm' data-bs-dismiss='modal' aria-label='Đóng'></button>">
  ...
  components: { Register },
    ...
    data(){
        return{
            ...
            show:false,
            componentKey: 0,
            currentAddress: 'Tìm kiếm khu vực của bạn',
            showclass:'',
    ...
    mounted() {
        ...
        //     jQuery("#user-menu-dropdown").slideToggle("slow");
        // });
